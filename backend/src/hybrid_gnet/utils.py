# ==============================================================================
# This file is taken from the repository: https://github.com/ngaggion/CheXmask-Database/blob/main/HybridGNet/utils/utils.py
# File has been modified, and all constants were moved to inference.py file
...
def genMatrixesLungs():
    from src.hybrid_gnet.inference import CONTOUR_SPLITS

    RLUNG, LLUNG, _ = CONTOUR_SPLITS
...
def genMatrixesLungsHeart():
    ...
    RLUNG, LLUNG, HEART = CONTOUR_SPLITS
